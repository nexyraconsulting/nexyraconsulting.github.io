...
**Hanken Grotesk** is the brand face. Sets the wordmark, all headings, all interface labels and all body copy.
...
**Neue Haas Grotesk Display** is named in the logo SVGs as the first fallback. Commercially licensed, so it is **not** distributed here; license it per seat from the foundry if you want it as the substitute. **Helvetica Neue / Arial** are the system fallbacks.
